...
if len(sys.argv) != 4:
    sys.exit("GIVE NAME OF LOCAL MAGNET LIST IN FOLDER GRID DATA : BETA : L")
...
for step in xrange(nsteps):
    ...
    var = pylab.imshow(conf,interpolation = 'nearest',vmin=0, vmax=1.0,cmap = pylab.get_cmap('cool'))    
    fig.colorbar(var)    
    pylab.savefig('beta_'+sys.argv[2]+'_L_'+sys.argv[3]+'_local_magnet_snapshot_%06i.png' % step, bbox_inches='tight')
