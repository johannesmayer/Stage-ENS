...
if len(sys.argv) != 4:
    sys.exit("GIVE ME INPUT IN FORM:\t J\tBETA\tNUMBER OF CLUSTER UPDATES")
...
for L in [200]:
    ...
    N_cluster_updates = int(sys.argv[3])
    ...
    outdir = "thermalisation_processes"
    ID = 'L_' + str(L) + "_beta_" + str(beta)
    filename = 'cluster_config_' + ID + '.npy'
