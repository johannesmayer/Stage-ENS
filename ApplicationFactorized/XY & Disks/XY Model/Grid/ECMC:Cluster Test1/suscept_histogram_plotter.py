...
if len(sys.argv) != 5:
    sys.exit("PLEASE GIVE INPUT IN FORM: EVENT SUSCEPT. DATA : MARKOV SUSCEPT. DATA : EVENT THERMAL CUT : CLUSTER THERMAL CUT")
...
ma_hist = plt.hist(ma, ev_binning,normed=True, alpha = 0.5, label='Cluster data',histtype = 'step')
