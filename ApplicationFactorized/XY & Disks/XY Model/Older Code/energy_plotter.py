...
for i_sweep in range(len(all_delta_phi)):
    all_energies.append(energy(J,all_delta_phi[i_sweep]))

print("ENERGY MEAN VALUE: "+str(numpy.mean(all_energies)))       
